...
// REMOVE THIS LINE: import { createRazorpayOrder } from '../../lib/razorpay'
...
export default function Store() {
  ...
  const handlePurchase = async (pdf) => {
    ...
    try {
      // Server-side API call to create order (FIXED: Using API route instead of direct import)
  ...
  const handleDownload = (pdf) => {
    // This would typically generate a signed URL from Supabase Storage
    alert(`Downloading ${pdf.title}`)
    // Implement actual download logic with Supabase Storage
  }
